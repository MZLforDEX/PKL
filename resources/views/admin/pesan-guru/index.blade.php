<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="font-extrabold text-lg md:text-2xl text-surface-900 tracking-tight">Pesan & Aduan Guru</h2>
            <p class="text-sm text-surface-500 mt-0.5 hidden sm:block">Kelola kendala teknis, administratif, atau masukan yang diajukan oleh Guru Pembimbing.</p>
        </div>
    </x-slot>
                                ...
                                <td class="whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white shrink-0 shadow-sm font-bold text-sm">
                                            {{ substr($p->guru?->user?->name ?? 'G', 0, 1) }}
                                        </div>
                                        <div>
                                            <div class="text-sm font-bold text-surface-900">{{ $p->guru?->user?->name ?? 'Guru Pembimbing' }}</div>
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="empty-state">
                                        ...
                                        <p class="text-surface-400 font-medium mt-3">Belum ada aduan atau pesan masuk dari Guru Pembimbing.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
