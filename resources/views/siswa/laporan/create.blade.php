<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-extrabold text-lg md:text-2xl text-surface-900 tracking-tight">Upload Laporan PKL</h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="card-premium p-6 sm:p-8">
                ...
                <form action="{{ route('siswa.laporan.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <label class="form-label">File Laporan <span class="text-surface-400 font-normal">(PDF, max 5MB)</span></label>
