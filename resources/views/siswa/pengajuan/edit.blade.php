    ...
    <div class="py-6 md:py-10 animate-fade-in">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="card-premium p-6 sm:p-8">
                <form action="{{ route('siswa.pengajuan.update', $pengajuan) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            <label class="form-label">File Dokumen Pendukung (PDF/DOC/DOCX, max 2MB) <span
                                    class="text-surface-400 font-normal">(biarkan kosong jika tidak
                                    diubah)</span></label>
