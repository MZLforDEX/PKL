<x-app-layout>
                ...
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-surface-500 mt-0.5">Saring data tabel dan unduh rekapan absen siswa bimbingan Anda dalam format Excel (.xls) berdasarkan periode.</p>
                        </div>
                    </div>
                    
                    <form id="filterExportForm" action="{{ route('guru.absensi.index') }}" method="GET" class="flex flex-wrap items-center gap-4">
                        {{-- Periode Select --}}
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            @if(request('periode_id'))
                                <a href="{{ route('guru.absensi.index') }}" class="btn-secondary !py-1.5 !px-3 inline-flex items-center justify-center hover:bg-surface-200" title="Reset">
    ...
    <script>
        function submitExport() {
            ...
            tempForm.action = "{{ route('guru.absensi.export') }}";
            tempForm.method = 'GET';
