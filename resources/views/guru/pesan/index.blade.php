    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-surface-500 mt-0.5 hidden sm:block">Kirim keluhan, masalah teknis, atau permintaan bantuan ke pihak Admin sekolah.</p>
            </div>
            <div>
                <a href="{{ route('guru.hubungi-admin.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-indigo-600 text-white rounded-xl text-xs font-bold hover:bg-indigo-700 transition-colors shadow-lg">
                            ...
                            <tr>
                                <td colspan="4">
                                    <div class="empty-state">
                                        ...
                                        <p class="text-surface-400 font-medium mt-3">Belum ada riwayat aduan yang dikirim ke admin.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
