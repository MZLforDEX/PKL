<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-extrabold text-lg md:text-2xl text-surface-900 tracking-tight">Detail Aduan Guru</h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    {{-- Status Card --}}
                    <div class="card-premium p-6">
                        <h4 class="text-xs font-bold text-surface-400 uppercase tracking-wider mb-3">Status Tiket</h4>
                        @php
                            $statusClasses = [
                    ...
                    {{-- Tanggapan Card --}}
                    <div class="card-premium p-6">
                        <h4 class="text-xs font-bold text-surface-400 uppercase tracking-wider mb-4">Balasan Admin</h4>
                        ...
                        @else
                            <div class="empty-state py-6">
                                ...
                                <p class="text-surface-400 text-xs font-medium mt-3 text-center">Menunggu tanggapan dari tim administrator sekolah.</p>
                            </div>
                        @endif
                    </div>
                </div>
