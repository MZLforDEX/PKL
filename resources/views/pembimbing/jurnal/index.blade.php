<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="font-extrabold text-lg md:text-2xl text-surface-900 tracking-tight">Validasi Jurnal PKL (Industri)</h2>
            <p class="text-sm text-surface-500 mt-0.5 hidden sm:block">Periksa dan berikan validasi pada jurnal harian siswa bimbingan di tempat Anda.</p>
        </div>
    </x-slot>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap text-right">
                                    <a href="{{ route('pembimbing.jurnal.show', $j) }}" class="inline-flex items-center gap-1.5 px-4 py-2 bg-white border border-surface-200 hover:border-brand-200 hover:text-brand-600 rounded-xl text-xs font-bold text-surface-700 transition-all shadow-sm">
