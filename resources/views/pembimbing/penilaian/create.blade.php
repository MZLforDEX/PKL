    ...
    <div class="py-6 md:py-10 animate-fade-in">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="card-premium p-6 sm:p-8">
                ...
                <form action="{{ route('pembimbing.penilaian.store', $pengajuanPkl) }}" method="POST"
                    x-data="{
                        items: [
                            { nama: 'Aspek Sikap dan Kedisiplinan Kerja', nilai: 80 },
                            { nama: 'Aspek Keterampilan Teknik & Kerja Lapangan', nilai: 80 },
                            { nama: 'Kualitas Penulisan & Pemaparan Laporan Akhir', nilai: 80 }
                        ],
                        addItem() {
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="catatan_evaluasi" rows="4" class="form-input-premium mt-1.5" placeholder="Berikan saran atau catatan mengenai kinerja siswa selama PKL...">{{ old('catatan_evaluasi') }}</textarea>
