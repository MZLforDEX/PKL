            ...
            <div class="mt-8 md:mt-12 grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <div class="card-premium p-6 md:p-8 bg-gradient-to-br from-indigo-600 via-indigo-650 to-purple-700 text-white border-indigo-500 animate-slide-up" style="animation-delay: 300ms">
                    ...
                    <p class="text-indigo-100 text-sm mb-6 leading-relaxed">
                        Terima kasih atas kontribusi Anda dalam membimbing siswa PKL SPARTA. Hubungi pihak sekolah jika terdapat kendala operasional atau administratif.
                    </p>
                    <a href="mailto:pkl-admin@sparta.sch.id" class="flex items-center justify-center w-full py-3 bg-white text-indigo-600 rounded-xl font-bold text-sm hover:bg-indigo-50 transition-colors shadow-lg">
